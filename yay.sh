...
## my blog: si9ma.com
##
## use this script to check if yay have installed
##
...
# check whether yay are installed
function check_yay
{
	pacman -Qi yay >/dev/null 2>&1
	echo $?
}
...
function install_yay
{
		...
		title="AUR And yay"
		msg="In order to complete instation, you need to enable AUR and install yay. Please select the repositories suitable for you. More details, please see \"https://wiki.archlinux.org/index.php/unofficial_user_repositories\"\n\n[ESC] to exit the installer.\n\nPlease confirm before typing the [ENTER], because you can't undo it."
